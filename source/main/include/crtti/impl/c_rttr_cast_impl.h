...
{
    using namespace ncore::nrtti::Traits;
    ...
    RTTR_STATIC_ASSERT(ncore::nrtti::impl::has_getTypeInfo_func<Arg>::value, CLASS_HAS_NO_TYPEINFO_DEFINIED__USE_MACRO_ENABLE_RTTI);
