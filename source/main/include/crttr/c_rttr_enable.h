...
namespace RTTR
{
    namespace impl
    {
        ...
        private:
            // extract the info
            static RTTR_INLINE void retrieve_impl(TypeInfo* outArray, int& i, int maximum, Traits::true_type)
            {
                TypeInfoFromBaseClassList<typename T::baseClassList>::fill(outArray, i, maximum);
            }
        ...
        public:
            static RTTR_INLINE void retrieve(TypeInfo* outArray, int& i, int maximum)
            {
                retrieve_impl(outArray, i, maximum, typename has_base_class_list<T>::type());
            }
        };
